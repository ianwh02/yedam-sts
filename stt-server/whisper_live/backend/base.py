...
class ServeClientBase(object):
    ...
    def __init__(
        ...
        # Voice activity / end-of-speech tracking (per-client)
        self.eos = False
        self.no_voice_activity_chunks = 0

        # Epoch counter for clear_buffer — transcription thread checks this
    ...
    def set_eos(self, eos):
        """Sets the End of Speech (EOS) flag (thread-safe)."""
        with self.lock:
            self.eos = eos
    ...
    def speech_to_text(self):
        ...
        while True:
            ...
            # Capture epoch before reading audio — if clear_buffer runs during
            # transcription, the epoch will have incremented and we discard the
            # stale result instead of sending it to the client after the ACK.
